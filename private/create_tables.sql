...
(
    ...
    attestation VARCHAR(788) NOT NULL,-- @todo variable length, @todo in bytes?
    public_key VARCHAR(88) NOT NULL,-- @todo should be 32 bytes, @todo in bytes
    key_handle VARCHAR(88) NOT NULL -- @todo should be 255, @todo in bytes?
)